                        ...
                        child: Form(
                          ...
                          child: Column(
                            children: [
                              // Username 필드******************
                              TextFormField(
                                key: ValueKey(1), // key값을 통해 입력값이 꼬이지 않도록 정리해준다
                                validator: (value) {
                              ...
                              // UserEmail 필드******************
                              TextFormField(
                                key: ValueKey(2), // key값을 통해 입력값이 꼬이지 않도록 정리해준다
                                validator: (value) {
                              ...
                              // Password 필드******************
                              TextFormField(
                                key: ValueKey(3), // key값을 통해 입력값이 꼬이지 않도록 정리해준다
                                validator: (value) {
                      ...
                      Container(
                        ...
                        child: Form(
                          ...
                          child: Column(
                            children: [
                              TextFormField(
                                key: ValueKey(4), // key값을 통해 입력값이 꼬이지 않도록 정리해준다
                                validator: (value) {
                                  if (value!.isEmpty || value.contains('@')) {
                                    return 'Please enter a valid email address.';
                                  }
                              ...
                              SizedBox(height: 8),
                              TextFormField(
                                key: ValueKey(5), // key값을 통해 입력값이 꼬이지 않도록 정리해준다
                                validator: (value) {
                                  if (value!.isEmpty || value.length < 6) {
                                    return 'Password must be at least 7 characters long.';
                                  }
